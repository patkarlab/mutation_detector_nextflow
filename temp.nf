...
process pindel{
	...
	sh /scratch/hematopath/hemoseq_v2/mutation_detector_nextflow/scripts/make_config.sh -s ${Sample}
...
process cava {
	...
	script:
	"""
	${params.cava_path}/cava -c ${params.cava_path}/config_v1.txt -t 10 -i $PWD/${Sample}/variants/${Sample}.somaticseq.vcf -o ${Sample}.somaticseq
	${params.cava_path}/cava -c ${params.cava_path}/config_v1.txt -t 10 -i $PWD/${Sample}/variants/${Sample}.combined.vcf -o ${Sample}.combined
