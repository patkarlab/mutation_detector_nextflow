...
include { TRIM; MAPBAM; MARK_DUPS; BQSR; APPLY_BQSR; ALIGNMENT_METRICS; INSERT_SIZE_METRICS; ALIGNMENT} from '../modules/fastq_to_bam/bam.nf'
...
workflow TRIM_MAPBAM{
	take:
		samples_ch
	main:
	
	TRIM(samples_ch, adapt)
	ALIGNMENT(TRIM.out, genome_loc, index_files)

	emit:
		final_bams_ch = ALIGNMENT.out
}
